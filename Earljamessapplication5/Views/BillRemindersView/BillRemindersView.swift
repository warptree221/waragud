...
struct BillRemindersView: View {
    @StateObject var billRemindersViewModel = BillRemindersViewModel()
        ...
        NavigationView {
            VStack {
                VStack {
                    ...
                    VStack(alignment: .leading, spacing: 0) {
                        Divider()
                            .frame(width: UIScreen.main.bounds.width,
                                   height: getRelativeHeight(1.0), alignment: .leading)
                            .background(ColorConstants.Bluegray100)
                        Text(StringConstants.kLblBillReminders)
                    ...
                    VStack {
                        Button(action: {
                            billRemindersViewModel.nextScreen = "DashboardView"
                        }, label: {
                            HStack(spacing: 0) {
                    ...
                    .frame(width: UIScreen.main.bounds.width, height: getRelativeHeight(33.0),
                           alignment: .leading)
                    .padding(.vertical, getRelativeHeight(705.0))
                }
                ...
                Group {
                    NavigationLink(destination: DashboardView(),
                                   tag: "DashboardView",
                                   selection: $billRemindersViewModel.nextScreen,
                                   label: {
                                       EmptyView()
                                   })
                }
...
struct BillRemindersView_Previews: PreviewProvider {
